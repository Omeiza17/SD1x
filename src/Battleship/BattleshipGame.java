 ...
 * We will do just a solo version, where the computer places the ships, and the human attempts to
 * sink them.
 *
 * We’ll play this game on a 20x20 ocean. This is larger than the ocean in the traditional
 * battleship game.
 * In this game we will have one 8-square Battleship, one 7-square Battlecruiser, two 6-square
 * Cruisers, two 5-square Light Cruisers, three 4-square Destroyers and four 3-square Submarines.
 * Finally, unlike the traditional game, A player can shoot 5 times in each turn.
 *
 * The computer places these 13 ships on the ocean in such a way that no ships are immediately
 ...
 * of a ship was hit.
 * However, when a ship is hit and sinks, the program prints out a message ”You just sank a
 * ship-type.”
 * After each shot, the computer re-displays the ocean with the new information.
 *
 ...
 *
 * When all ships have been sunk, the program prints out a message that the game is over, and tells
 * the user how many shots were required.
 */
public class BattleshipGame {
     ...
     *  All input/output is done here (although some of it is done by calling a print() method in
     *  the Ocean class.)
    ...
    public static void main(String[] args) {
        ...
        while (true) {
            ...
            String format = "a, b; c, d; e, f; g, h; i, j";
            System.out.printf("Please adhere to the following format :: %s\n5 places to shoot " +
                    "at:\n", format);
